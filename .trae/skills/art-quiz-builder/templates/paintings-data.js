...
var DEFAULT_PAINTINGS = [
    { id: 1, image: 'art1_001.jpg', title: '《梅杜莎之筏》', artist: '籍里柯', year: '1819', options: ['《梅杜莎之筏》', '《自由引导人民》', '《拿破仑加冕》', '《荷拉斯兄弟之誓》'], explanation: '法国浪漫主义画家籍里柯的杰作，描绘了梅杜莎号海难幸存者在木筏上绝望求生的场景。奶龙们挤在筏子上的样子，莫名有点喜感...' },
    ...
    { id: 22, image: 'art4_007.jpg', title: '《加殁医生像》', artist: '梵高', year: '1890', options: ['《加殁医生像》', '《自画像》', '《邮递员鲁兰》', '《嘉舍医师的花园》'], explanation: '梵高为治疗他的加殁医生画的肖像，忧郁的蓝色调。奶龙医生：你病得不轻啊！' },
